...
public class Main {
    ...
    while (true) {
      ...
      switch (opcao) {
        ...
        case "2":
          ...
          break;
        case "3":
          System.out.println("Cadastrar Caderno - em desenvolvimento");
          break;
        case "4":
          System.out.println("Excluir Caderno - em desenvolvimento");
          break;
        case "5":
          ...
          if (cupom.isPresent()) {
            pedidoNegocio.salvar(pedido, clienteLogado, cupom.get());
          } else {
  ...
  private static void identificarUsuario(String cpf) {
    ...
    if (resultado.isPresent()) {
      ...
      System.out.println(
        String.format("Olá %s! Você está logado.", cliente.getNome())
      );
